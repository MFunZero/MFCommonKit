...
let isIphoneX = UIScreen.sk_ScreenHeight() > 810
...
public class ActionSheetView: UIView {
    ...
    /// 其他按钮图标
    private var otherButtonIconNames: [String] = []
    /// 点击事件回调
    ...
    public convenience init(title: String? = nil,
                            ...
                            otherButtonTitles: [String] = [],otherButtonIconNames: [String] = [],
                            clickedHandler: ActionSheetClickedHandler? = nil) {
        self.init()
        self.title = title
        self.otherButtonTitles = otherButtonTitles
        self.otherButtonIconNames = otherButtonIconNames
...
//            UIColor(hex6: 0xededee)
    ...
    func setupSubViews() {
        ...
        //
        let divisionViewHeight: CGFloat = (cancelButtonTitle != nil) ? 1.0 : 0.0
...
extension ActionSheetView: UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if otherButtonIconNames.count > indexPath.row {
            cell.iconView.image = UIImage(named: otherButtonIconNames[indexPath.row])
